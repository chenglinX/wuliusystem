    ...
    <tr>
        ...
        <td width="484" valign="top"><table width="100" border="0" cellpadding="0" cellspacing="0">
            ...
            <table width="370" border="0" cellpadding="0" cellspacing="0" background="image/19.jpg">
                <%
                    sql="select ID,EnterpriseSort,EnterpriseName,Operation,WorkArea,Address,UserName from tb_Enterprise order by IssueDate desc limit 8";
                    try
                    {
                        rs1=connection.executeQuery(sql);
                        while(rs1.next())
...
</table><jsp:include page="Manager/down.jsp" flush="true" />
