...
<table class="table table-hover"  style="width: 300px; margin: 0 auto; font-size: 10px" >
    ...
    <tr>
        ...
        <td width="245" height="32" align="center">
            ...
            <a href="#"onClick="window.open('knowledge_change.jsp?id=<%=code%>','','width=790,height=530');">修改</a></td>
        <td width="245" height="32" align="center">

            <a href="#"onClick="window.open('knowledge_delete.jsp?id=<%=code%>','','width=790,height=530');">删除</a></td>
    </tr>
    <%
            if(!rs.next())
                break;
