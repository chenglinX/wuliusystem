...
<table class="table table-hover"  style="width: 300px; margin: 0 auto; font-size: 10px" >
    <tr>
        <td height="38" align="center" colspan="6">知识信息</td>
    </tr>
    <tr>
            ...
            <table width="786" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    <td width="786" height="30" colspan="9" align="right">
                        共<%=pagecount%>页&nbsp;&nbsp;
                        <button type="button" class="btn btn-default"><a href="knowledge_select.jsp?topage=<%=1%>">第一页</a></button>
                        &nbsp;&nbsp;
                        <a href="knowledge_select.jsp?topage=<%=showpage-1%>">上一页</a>&nbsp;&nbsp;
                        <a href="knowledge_select.jsp?topage=<%=showpage+1%>">下一页</a>&nbsp;&nbsp;
                        <button type="button" class="btn btn-default"><a href="knowledge_select.jsp?topage=<%=pagecount%>">最后一页</a></button>
